...
-- Mon 27 Apr 2020 11:07:26 PM CST
...
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`Login` (
  ...
  PRIMARY KEY (`usuario`, `personal_ajepp_id`),
  INDEX `fk_Login_personal_ajepp1_idx` (`personal_ajepp_id` ASC),
  CONSTRAINT `fk_Login_personal_ajepp1`
...
-- -----------------------------------------------------
-- Table `Ventas_Partes`.`piezas_vehiculo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`piezas_vehiculo` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `modelo_vehiculo_id` INT NOT NULL,
  `clasificacion_pieza_id` INT NOT NULL,
  `pie_nombre` VARCHAR(100) NULL,
  `pie_img` VARCHAR(100) NULL,
  `pie_descripcion` TEXT NULL,
  PRIMARY KEY (`id`, `modelo_vehiculo_id`, `clasificacion_pieza_id`),
  INDEX `fk_piezas_vehiculo_modelo_vehiculo1_idx` (`modelo_vehiculo_id` ASC),
  INDEX `fk_piezas_vehiculo_clasificacion_pieza1_idx` (`clasificacion_pieza_id` ASC),
  CONSTRAINT `fk_piezas_vehiculo_modelo_vehiculo1`
    FOREIGN KEY (`modelo_vehiculo_id`)
    REFERENCES `Ventas_Partes`.`modelo_vehiculo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_piezas_vehiculo_clasificacion_pieza1`
...
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`detalles_pieza_tienda` (
  ...
  `piezas_vehiculo_id` INT NOT NULL,
  PRIMARY KEY (`id`, `piezas_vehiculo_id`),
  UNIQUE INDEX `pie_numero_UNIQUE` (`pie_numero` ASC),
  UNIQUE INDEX `pie_serie_UNIQUE` (`pie_serie` ASC),
  INDEX `fk_detalles_pieza_tienda_piezas_vehiculo1_idx` (`piezas_vehiculo_id` ASC),
  CONSTRAINT `fk_detalles_pieza_tienda_piezas_vehiculo1`
    FOREIGN KEY (`piezas_vehiculo_id`)
    REFERENCES `Ventas_Partes`.`piezas_vehiculo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`detalles_pieza_bodega` (
  ...
  `piezas_vehiculo_id` INT NOT NULL,
  PRIMARY KEY (`id`, `compra_proveedor_id`, `piezas_vehiculo_id`),
  UNIQUE INDEX `pie_numero_UNIQUE` (`pie_numero` ASC),
  INDEX `fk_detalles_pieza_bodega_compra_proveedor1_idx` (`compra_proveedor_id` ASC),
  INDEX `fk_detalles_pieza_bodega_piezas_vehiculo1_idx` (`piezas_vehiculo_id` ASC),
  CONSTRAINT `fk_detalles_pieza_bodega_compra_proveedor1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_detalles_pieza_bodega_piezas_vehiculo1`
    FOREIGN KEY (`piezas_vehiculo_id`)
    REFERENCES `Ventas_Partes`.`piezas_vehiculo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `Ventas_Partes`.`compania`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`compania` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Ventas_Partes`.`menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`menu` (
  `id` INT NOT NULL,
  `contenido` TEXT NULL,
  `order` INT NULL,
...
-- -----------------------------------------------------
-- Table `Ventas_Partes`.`registro_pieza_compra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`registro_pieza_compra` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `pie_numero` VARCHAR(100) NULL,
  `pei_precio_compra` FLOAT NULL,
  `pie_precio_venta` FLOAT NULL,
  `pie_fecha_compra` DATETIME NULL,
  `pie_detalle` TEXT NULL,
  `pie_img` TEXT NULL,
  `compra_proveedor_id` INT NOT NULL,
  PRIMARY KEY (`id`, `compra_proveedor_id`),
  INDEX `fk_registro_pieza_compra_compra_proveedor1_idx` (`compra_proveedor_id` ASC),
  CONSTRAINT `fk_registro_pieza_compra_compra_proveedor1`
    FOREIGN KEY (`compra_proveedor_id`)
    REFERENCES `Ventas_Partes`.`compra_proveedor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
