...
-- Sat 14 Mar 2020 12:26:01 AM CST
...
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`ventas` (
  ...
  `personal_ajepp_id` INT NOT NULL,
  `detalles_pieza_tienda_id` INT NOT NULL,
  `detalles_pieza_tienda_clasificacion_pieza_id` INT NOT NULL,
  PRIMARY KEY (`id`, `tipo_pago_id`, `cliente_id`, `personal_ajepp_id`, `detalles_pieza_tienda_id`, `detalles_pieza_tienda_clasificacion_pieza_id`),
  ...
  INDEX `fk_ventas_detalles_pieza_tienda1_idx` (`detalles_pieza_tienda_id` ASC, `detalles_pieza_tienda_clasificacion_pieza_id` ASC),
  ...
  CONSTRAINT `fk_ventas_detalles_pieza_tienda1`
    FOREIGN KEY (`detalles_pieza_tienda_id` , `detalles_pieza_tienda_clasificacion_pieza_id`)
    REFERENCES `Ventas_Partes`.`detalles_pieza_tienda` (`id` , `clasificacion_pieza_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
