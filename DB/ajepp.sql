...
-- Wed 18 Mar 2020 08:16:46 AM CST
...
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`piezas_vehiculo` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `pie_nombre` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `pie_nombre_UNIQUE` (`pie_nombre` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`clasificacion_pieza` (
  ...
  PRIMARY KEY (`id`, `modelo_vehiculo_id`, `piezas_vehiculo_id`),
  INDEX `fk_clasificacion_pieza_modelo_vehiculo1_idx` (`modelo_vehiculo_id` ASC),
  INDEX `fk_clasificacion_pieza_piezas_vehiculo1_idx` (`piezas_vehiculo_id` ASC),
  CONSTRAINT `fk_clasificacion_pieza_modelo_vehiculo1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_clasificacion_pieza_piezas_vehiculo1`
...
-- -----------------------------------------------------
-- Table `Ventas_Partes`.`division_pieza`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Ventas_Partes`.`division_pieza` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `pie_nombre` VARCHAR(70) NULL,
  `pie_img` VARCHAR(100) NULL,
  `piezas_vehiculo_id` INT NOT NULL,
  PRIMARY KEY (`id`, `piezas_vehiculo_id`),
  INDEX `fk_division_pieza_piezas_vehiculo1_idx` (`piezas_vehiculo_id` ASC),
  CONSTRAINT `fk_division_pieza_piezas_vehiculo1`
    FOREIGN KEY (`piezas_vehiculo_id`)
    REFERENCES `Ventas_Partes`.`piezas_vehiculo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
