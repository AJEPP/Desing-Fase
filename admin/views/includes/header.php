...
<link rel="stylesheet" type="text/css" href="http://admin.swrbicu.com/views/assets/css/datatable.css"/>
<!-- Custom styles for this template-->
<link href="http://<?php echo $_SERVER['SERVER_NAME'];?>/views/assets/css/sb-admin-2.min.css" rel="stylesheet">
