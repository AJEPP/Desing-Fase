<?php
    ...
    class LinksModel
    {
        ...
        {
            $this->links = array("dashboard", "login","departamento","marca","tipoVehiculo","usuarios","cargo","modeloVehiculo","piezasVehiculo", "usuarios", "pos", "proveedores", "salidas", "entradas", "compras");
        }
